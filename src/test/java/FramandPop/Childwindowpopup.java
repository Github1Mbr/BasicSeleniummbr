...
public class Childwindowpopup {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Set<String> windows = driver.getWindowHandles();//windows
...
//		{
//			if(!win.equals(mainID))//eliminate the main window ID //! using not equal to window id
//			{
//				System.out.println("This is child ID - "+win);
//				driver.switchTo().window(win);
//				break;
//			}
//			//we get a code of webpage unique id(Parent and child) because that is 2 windows 
//		}
		...
		for(String win:windows)
		{
			...
			if(currentWinTitle.contains("Selenium"))//child id
			{
		...
		for(String win:windows)
		{
			WebDriver currentWindowID = driver.switchTo().window(win);
			String currentWinTitle = currentWindowID.getTitle();
			if(currentWinTitle.contains("Frames"))//parent id 
			{
				System.out.println(currentWinTitle);
				break;
			}
