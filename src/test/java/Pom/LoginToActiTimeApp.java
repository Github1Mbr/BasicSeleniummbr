...
//		driver.findElement(By.id("loginButton")).click();
		...
		//Read username and password from Property File //logic for properity file and collecting data  
		FileInputStream fis = new FileInputStream(".\\src\\test\\resources\\Data.properties");
		Properties p = new Properties();
		p.load(fis);
		String USERNAME = p.getProperty("username");//parameter,get properity is ready the username 
		String PASSWORD = p.getProperty("password");//parameters
...
//		lp.loginToApp("admin", "manager");//instand of this we are using username and password 
		
		lp.loginToApp(USERNAME, PASSWORD); //reading from properity file by perametrized
