...
public class WebdriverallactiTimeforclassname {
...
//	WebElement passordEle=driver.findElement(By.name("pwd"));
	...
	//Step 6 : Click on organization link in the Classname locator
	driver.findElement(By.className("initial")).click();
	//Step 7 : Click on organization link in the Classname locator
